...
const Login = () => {
  ...
  return (
    <div className="min-h-screen mt-20 flex items-center justify-center px-4 py-10" style={{ background: "linear-gradient(135deg, #f5f7fa 0%, #c3cfe2 100%)" }}>
      <motion.div 
      ...
      >
        ...
        <motion.div 
          ...
          style={{ background: "linear-gradient(135deg, #0761b5 0%, #054a8a 100%)" }}
        >
          <div className="text-center text-white">
            ...
            <div className="space-y-4 text-left max-w-sm">
              {[
                { title: "Real-time Analytics", desc: "Track your business performance" },
                { title: "Inventory Management", desc: "Never run out of stock" },
                { title: "Secure Payments", desc: "Bank-level encryption" }
              ].map((item, index) => (
                <motion.div 
                  key={index}
        ...
        >
          <motion.h2 variants={itemVariants} className="text-3xl font-bold text-center text-gray-800 mb-2">
            Welcome Back
          </motion.h2>
          <motion.p variants={itemVariants} className="text-center text-gray-500 mb-8">
          ...
          <div className="space-y-5">
            ...
            <motion.div variants={itemVariants} className="flex items-center justify-between text-sm">
              <label className="flex items-center gap-2 cursor-pointer">
                <input type="checkbox" className="rounded" style={{ accentColor: "#0761b5" }} />
                <span className="text-gray-600">Remember me</span>
              </label>
              <span className="font-semibold hover:underline cursor-pointer" style={{ color: "#0761b5" }}>
                Forgot password?
              </span>
            </motion.div>
